const deathsCSV = async () => 
{
  const array = []
  await d3.csv("/static/data/gustavo/confirmados/aparecida-mortes-por-faixa-etária.csv", data => { array.push(data)});
  return array;
}

const deathsChart = async () => 
{
  const ages = await deathsCSV()
  ...
  const cases_by_age = new Chart('DeathsByAge',
  {
    type: "bar",
    data: 
    {
